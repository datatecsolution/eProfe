...
public class AdapterAsignatura extends ArrayAdapter<Asignatura> {
    ...
    public AdapterAsignatura(@NonNull Context context, @NonNull List<Asignatura> a) {
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
        {
            convertView = ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.item_asignatura,null);
        }
